...
<button class="inainte" style="float:right" onclick="inainte(1)">></button>
    <div class="img"><a href="meca.php"><img id="img" src="fizi.jpg"/></a></div>
    <div class="img"><a href="termo.php"><img id="img" src="fizi1.jpg"/></a></div>
    <div class="img"><a href="opti.php"><img id="img" src="fizi2.jpg"/></a></div>
    <div class="img"><a href="electri.php"><img id="img" src="fizi3.jpg"/></a></div>
    <div class="img"><a href="roboti.php"><img id="img" src="bici.webp"/></a></div>
</div>
<script>
    let index = 1;
    Apare(index);
